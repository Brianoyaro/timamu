...
def create_app():
    ...
    app.register_blueprint(wellness_bp, url_prefix='/api/wellness')  # Register wellness routes
    app.register_blueprint(reviews_bp, url_prefix='/api/reviews')  # Register reviews routes
